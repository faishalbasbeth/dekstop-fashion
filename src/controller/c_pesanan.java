...
public class c_pesanan {
    ...
    private  class klik implements KeyListener {
        ...
        public void actionPerformed(ActionEvent e) {
          views.gettabel().setModel(models.getTabel());
            ...
            String total_harga =  views.get_total_harga().getText();
        ...
        public void itemStateChanged(ItemEvent e) {
            ...
            if (views.getid_bahan().getSelectedIndex() == 0) {
                ...
                try {
                    ...
                    Logger.getLogger(c_pesanan.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
